...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        # Video Feed
        self.videoFeedFrame = QtWidgets.QFrame()
        self.videoFeedFrame.setFrameShape(QtWidgets.QFrame.Shape.Box)
        self.videoLayout = QtWidgets.QVBoxLayout(self.videoFeedFrame)
        ...
        self.videoReportLayout.addWidget(self.videoFeedFrame, 2)
